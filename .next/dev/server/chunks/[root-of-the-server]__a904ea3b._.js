...
Return ONLY the icon name, nothing else.`
        ...
        return {
            icon: (chatCompletion.choices[0]?.message?.content || "").trim().toLowerCase().replace(/['"]/g, "")
        };
    }),
...
const gmailRouter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["router"])({
    getStatus: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["protectedProcedure"].query(async ({ ctx })=>{
        ...
        return {
            isConnected: !!user?.gmailRefreshToken
        };
    }),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a904ea3b._.js.map